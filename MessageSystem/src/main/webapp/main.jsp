	...
	<body>
					...
					<!-- Two -->
							<section id="two">
								<div class="inner">
									...
									%>
										<!-- 로그인이 되어있는 경우 :email님에게 온 메시지입니다. -->
							...
							<section>
								...
								<div class="field half first">
									...
									<div class="field half">
										...
										<input type="text" id = "receiveEmail" name="receiveEmail" id="email" placeholder="보낼 사람 이메일"/>
									</div>
		...
		<!-- Scripts -->
			...
			<script>
				...
				//제이쿼리 사용
				var isSubmit = false;
				//event객체 : DOM 과 관련된 이벤트 발생하면 관련 정보를 가지고 있는 객체
